    ...
    public static class DataSeeder
    {
        ...
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Festival>().HasData(
                // Music
                new Festival { Id = 1, Title = "Sarajevo Jazz Nights", StartDate = baseStartDate.AddDays(15), EndDate = baseStartDate.AddDays(19), BasePrice = 49.99m, Location = "43.8563,18.4131", CreatedAt = fixedDate, IsActive = true, CityId = 1, SubcategoryId = 1, OrganizerId = 1, Logo = ImageConversion.ConvertImageToByteArray("Assets", "1.png") }, // Sarajevo - June 16-20, 2025
                new Festival { Id = 2, Title = "Mostar Rock Fest", StartDate = baseStartDate.AddDays(40), EndDate = baseStartDate.AddDays(42), BasePrice = 39.50m, Location = "43.3438,17.8078", CreatedAt = fixedDate, IsActive = true, CityId = 5, SubcategoryId = 2, OrganizerId = 2, Logo = ImageConversion.ConvertImageToByteArray("Assets", "2.png") }, // Mostar - July 11-13, 2025

                // Film
                new Festival { Id = 3, Title = "Cannes Film Festival", StartDate = baseStartDate.AddDays(70), EndDate = baseStartDate.AddDays(81), BasePrice = 99.00m, Location = "43.552847,7.017369", CreatedAt = fixedDate, IsActive = true, CityId = 12, SubcategoryId = 4, OrganizerId = 3, Logo = ImageConversion.ConvertImageToByteArray("Assets", "3.png") }, // Cannes, France - Aug 10-21, 2025
                new Festival { Id = 4, Title = "Sundance Film Festival", StartDate = baseStartDate.AddDays(25), EndDate = baseStartDate.AddDays(35), BasePrice = 79.00m, Location = "40.6461,-111.4980", CreatedAt = fixedDate, IsActive = true, CityId = 26, SubcategoryId = 4, OrganizerId = 4, Logo = ImageConversion.ConvertImageToByteArray("Assets", "4.png") }, // Park City, Utah, USA - June 26 - July 6, 2025

                // Gaming
                new Festival { Id = 5, Title = "E3 (Electronic Entertainment Expo)", StartDate = baseStartDate.AddDays(55), EndDate = baseStartDate.AddDays(57), BasePrice = 59.00m, Location = "34.0522,-118.2437", CreatedAt = fixedDate, IsActive = true, CityId = 17, SubcategoryId = 8, OrganizerId = 5, Logo = ImageConversion.ConvertImageToByteArray("Assets", "5.png") }, // Los Angeles, USA - July 26-28, 2025
                new Festival { Id = 6, Title = "LEC Finals", StartDate = baseStartDate.AddDays(120), EndDate = baseStartDate.AddDays(122), BasePrice = 45.00m, Location = "50.9375,6.9603", CreatedAt = fixedDate, IsActive = true, CityId = 27, SubcategoryId = 7, OrganizerId = 6, Logo = ImageConversion.ConvertImageToByteArray("Assets", "6.png") } // Cologne, Germany - Aug 30-31, 2025
            );
